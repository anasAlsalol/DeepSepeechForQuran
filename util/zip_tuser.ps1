...
Import-CSV "/notebooks/quran_data/quran_tusers/csv/quran_all.csv" |  Where-Object {[int]$_.wav_filesize -lt $wav_filesize} | Select-Object wav_filename  | Out-File -FilePath $tempfilename
